...
abstract class HTMLDocument extends Document {
   ...
   * MDN
   */
  private[saferdom] def defaultView: Window = js.native
   ...
   * MDN
   */
  private[saferdom] def head: HTMLHeadElement = js.native
   ...
   * MDN
   */
  private[saferdom] var body: HTMLElement = js.native
   ...
   * MDN
   */
  private[saferdom] def activeElement: Element = js.native
...
abstract class HTMLTableElement extends HTMLElement {
   ...
   * MDN
   */
  private[saferdom] var tFoot: HTMLTableSectionElement = js.native
   ...
   * MDN
   */
  private[saferdom] var caption: HTMLTableCaptionElement = js.native
   ...
   * MDN
   */
  private[saferdom] var tHead: HTMLTableSectionElement = js.native
   ...
   * collection immediately before the &lt;tr&gt; element at the given index position. If
...
abstract class HTMLSelectElement extends HTMLElement {
   ...
   * MDN
   */
  private[saferdom] def form: HTMLFormElement = js.native
  ...
  /**
   * Reflects the multiple HTML attribute, which indicates whether multiple items can
   * be selected.
   *
   * MDN
   */
  ...
  // TODO: Push signature change upstream.
  /**
  ...
  // TODO: Push signature change upstream.
  @scala.scalajs.js.annotation.JSBracketAccess
  def update(index: Int, v: Element): Unit = js.native
...
abstract class HTMLMetaElement extends HTMLElement {
  ...
  // TODO: Deprecated. See https://html.spec.whatwg.org/multipage/semantics.html#the-meta-element
...
abstract class HTMLOptionElement extends HTMLElement {
  ...
  // TODO: Remove this. See https://html.spec.whatwg.org/multipage/forms.html#the-option-element
...
// TODO: Shouldn't extend DOMList[Element]. See https://dom.spec.whatwg.org/#htmlcollection
/**
...
abstract class HTMLCollection extends DOMList[Element] {
   ...
   * MDN
   */
  private[saferdom] def namedItem(name: String): Element = js.native
}
...
abstract class HTMLImageElement extends HTMLElement {
  ...
  // TODO: Remove this. See https://html.spec.whatwg.org/multipage/embedded-content.html#the-img-element
...
abstract class HTMLTableRowElement
  ...
  // TODO: Deprecated. https://html.spec.whatwg.org/multipage/tables.html#the-tr-element
...
abstract class HTMLQuoteElement extends HTMLElement {
  ...
  // TODO: Remove this. See https://html.spec.whatwg.org/multipage/semantics.html#the-blockquote-element
...
abstract class HTMLLegendElement extends HTMLElement {
  // TODO: Deprecated. See https://html.spec.whatwg.org/multipage/forms.html#the-legend-element
...
abstract class HTMLIFrameElement extends HTMLElement with GetSVGDocument {
   ...
   * MDN
   */
  private[saferdom] def contentWindow: Window = js.native
  ...
  // TODO: Doesn't exist. https://html.spec.whatwg.org/multipage/embedded-content.html#the-iframe-element
   ...
   * MDN
   */
  private[saferdom] def contentDocument: Document = js.native
  ...
  // TODO: Should be a def. See https://html.spec.whatwg.org/multipage/embedded-content.html#the-iframe-element
  // TODO: Should be DOMTokenList, not DOMSettableTokenList. See https://html.spec.whatwg.org/multipage/embedded-content.html#the-iframe-element
  /**
...
abstract class HTMLBodyElement extends HTMLElement {
  ...
  // TODO: Non-standard. See https://html.spec.whatwg.org/multipage/semantics.html#the-body-element
...
abstract class HTMLTableSectionElement
  ...
  // TODO: Shouldn't have default value. See https://html.spec.whatwg.org/multipage/tables.html#htmltablesectionelement
  /**
  ...
  // TODO: Non-standard. https://html.spec.whatwg.org/multipage/tables.html#htmltablesectionelement
  def moveRow(indexFrom: Int = js.native,
      indexTo: Int = js.native): Object = js.native
...
abstract class HTMLInputElement extends HTMLElement {
  ...
  // TODO: Doesn't exist. https://html.spec.whatwg.org/multipage/forms.html#the-input-element
  ...
  // TODO: Should be a def. See https://html.spec.whatwg.org/multipage/forms.html#the-input-element
  private[saferdom] var files: FileList = js.native
  ...
  // TODO: Should be Double. See https://html.spec.whatwg.org/multipage/forms.html#the-input-element
  // TODO: MDN comment is wrong. Doesn't return null.
  /**
  ...
  // TODO: Should be a def. https://html.spec.whatwg.org/multipage/forms.html#the-input-element
  /**
   ...
   * MDN
   */
  private[saferdom] var list: HTMLElement = js.native
...
abstract class HTMLTableCellElement
  ...
  // TODO: Should be var. https://html.spec.whatwg.org/multipage/tables.html#htmltablecellelement
  /**
...
abstract class HTMLTextAreaElement extends HTMLElement {
  ...
  // TODO: Doesn't exist. https://html.spec.whatwg.org/multipage/forms.html#the-textarea-element
  var status: js.Any = js.native
...
abstract class HTMLMediaElement extends HTMLElement {
   ...
   * MDN
   */
  private[saferdom] def error: MediaError = js.native
...
// TODO: Shouldn't exist. https://html.spec.whatwg.org/multipage/semantics.html#the-dt-element
@js.native
...
abstract class HTMLElement extends Element {
   ...
   */
  private[saferdom] override def ownerDocument: HTMLDocument = js.native
}
...
abstract class HTMLObjectElement extends HTMLElement with GetSVGDocument {
  ...
  // TODO: Doesn't exist. https://html.spec.whatwg.org/multipage/embedded-content.html#the-object-element
...
abstract class HTMLProgressElement extends HTMLElement {
  ...
  // TODO: Doesn't exist. https://html.spec.whatwg.org/multipage/forms.html#the-progress-element
...
abstract class HTMLFormElement extends HTMLElement {
  ...
  // TODO: Doesn't exist. https://html.spec.whatwg.org/multipage/forms.html#the-form-element
  /**
  ...
  // TODO: Fix js.Any. https://html.spec.whatwg.org/multipage/forms.html#the-form-element
  @scala.scalajs.js.annotation.JSBracketAccess
